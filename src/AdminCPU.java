...
public class AdminCPU extends JFrame{
	MySql db = new MySql();
				...
				new ActionListener(){
					public void actionPerformed(ActionEvent event){
						...
						if(choice == JOptionPane.YES_OPTION){
							...
							String sql = "INSERT INTO `cpu_list` (`Product ID`, `Model`, `Regular Price`, `Discounted Price`, `Quantity`) VALUES ('"+ realId +"', '"+ mText +"', '"+ realPrice +"', '"+ realDiscountPrice +"', '"+ realQuantity +"')";
							db.addProduct(sql);
